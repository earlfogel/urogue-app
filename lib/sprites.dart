...
class SpriteSheet {
  ...
  void initialize() async {
    ...
    monstTile[353] = 148; // evil sorceress
    monstTile[354] = 166; // evil sorcerer
    ...
    monstStyle[263] = Colors.grey.shade100; // bone devil
